...
`{"userId": Integer}`   
[POST] /duo/request/{userId} (듀오 요청)
[PUT] /duo/accept/{userId} (듀오 요청 수락)
[DELETE] /duo/decline/{userId} (듀오 요청 거절)
...
/rest/duo/accept/{userId} (PUT/듀오 요청 수락)   
/rest/duo/decline/{userId} (DELETE/듀오 요청 거절)   
