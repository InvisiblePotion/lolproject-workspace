...
[GET] /user/findId#(lolName, userCode) (아이디 찾기)   
[GET] /user/findpw#(userCode) (비밀번호 찾기)   
`("userCode": String)`   
...
/rest/user/code/regenerate#(userId) (유저 코드 재발급 요청)   
...
### 비동기:
> /rest/user/findId#(lolName, userCode) (GET/아이디 찾기)   
...
### 비동기:
> /user/findpw#(userId, userCode) (GET/비밀번호 찾기)   
