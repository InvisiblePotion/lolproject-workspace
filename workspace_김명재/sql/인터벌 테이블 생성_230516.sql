-- DROP TABLE CHAMPION_INFO CASCADE CONSTRAINTS;
-- DROP TABLE CHAMPION_ITEM_BOOTS CASCADE CONSTRAINTS;
-- DROP TABLE CHAMPION_ITEM_BUILD CASCADE CONSTRAINTS;
-- DROP TABLE CHAMPION_ITEM_START CASCADE CONSTRAINTS;
-- DROP TABLE CHAMPION_MATCHUP CASCADE CONSTRAINTS;
-- DROP TABLE CHAMPION_RUNE CASCADE CONSTRAINTS;
-- DROP TABLE CHAMPION_SKILL CASCADE CONSTRAINTS;
-- DROP TABLE CHAMPION_SPELL CASCADE CONSTRAINTS;
...
(
  ...
  win_rate          NUMBER NOT NULL,
  kda               NUMBER NOT NULL,
  kill_involve_rate NUMBER NOT NULL,
  dealt_to_champ    NUMBER(6)   NOT NULL,
  position_win_rate NUMBER NOT NULL,
  ban_rate          NUMBER NOT NULL,
...
(
  ...
  champ_id    NUMBER(3)   NOT NULL,
  lane        VARCHAR(7)  NOT NULL,
  skill_build VARCHAR(50) NOT NULL,
  pick_rate   NUMBER NOT NULL,
  game_count  NUMBER(6)   NOT NULL,
  win_rate    NUMBER NOT NULL,
