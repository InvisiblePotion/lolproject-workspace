...
/*
 * @PostMapping("/join") public @ResponseBody Integer join(@RequestParam
 * Map<String, Integer> join) { int join1 = test2MM.join(join);
 * System.out.println("join1: " + join1); return join1; }
 * 
 * }
 */
